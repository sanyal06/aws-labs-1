...
- Download a sample Inventory application and the AWS SDK
...
For time being if you allow http access from anywhere in the SG then you should be able to brows the sample app you just installed.

Consider that you created an instance and configured your app on it. You can also save this as a template so that you will not have start from scratch for further quick creation of them.

Select the MyWebServer - Instance dropdown - Image - Create image.
